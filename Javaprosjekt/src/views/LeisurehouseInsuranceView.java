 ...
 * @author Audun
 */
public class LeisurehouseInsuranceView extends CustomPanel {
    /*
 * Made by
 * Rudi Yu s231776
 * Audun Brustad s236341
 */
    ...
    private CustomTextField adress, yearBuilt, type, material, standard, houseSize, amountBuilding, amountContents, lease, premium, conditions;
    ...
    public LeisurehouseInsuranceView()
    {
        initComponents();
